    ...
    return (
        <>
            <div className="bg-gradient-to-r from-cc-red to-cc-blue min-h-screen flex flex-col justify-center items-center text-white">
                ...
                <div className="min-h-screen bg-neutral-900/30 text-white p-8 rounded-md mb-8">
                    <div className="max-w-3xl mx-auto">
                        <h1 className="text-4xl font-bold mb-6">Privacy Policy</h1>
                        <p className="mb-4">Effective Date: 14 June, 2024</p>
                        ...
                        <p className="mb-4">
                            We do not sell, trade, or otherwise transfer your IP address to outside parties. This does not include trusted third parties who assist us in operating our website, conducting our business, or servicing you, so long as those parties agree to keep this information confidential.
                        </p>
